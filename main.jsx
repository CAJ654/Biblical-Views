...
const categories = [
  {
    id: "hell",
    icon: "🔥",
    title: "Hell & Eternal Destiny",
    question: "What happens to the unsaved after death?",
    views: [
      {
      ...
      },
      {
        ...
        spectrum: 50,
        tags: ["Evangelical", "Adventist", "Growing"],
        summary: "The unsaved cease to exist after final judgment — they are destroyed rather than tormented forever. Only believers receive immortality as a gift; it is not inherent to human nature. Sometimes called 'Conditionalism.'",
        key_texts: ["Matt 10:28", "Rom 6:23", "2 Pet 3:7", "Mal 4:1–3"],
        proponents: "Edward Fudge, John Stott (tentatively), Clark Pinnock, Rethinking Hell movement",
        notes: "Distinct from soul sleep, though often held together. The judgment is still real and final — non-existence is the penalty."
      },
      {
  ...
  },
  {
    ...
    views: [
      ...
      },
      {
        ...
        notes: "Makes careful distinction between 'tribulation' (man's persecution) and 'wrath' (God's judgment). The rapture precedes the Day of the Lord's wrath specifically."
      },
      {
        ...
        notes: "The historic view of the church before Darby. Common in Reformed, Anglican, and many charismatic circles."
      },
      {
  ...
  },
  {
    ...
    question: "How does God save, and can salvation be lost?",
    views: [
      {
        name: "Calvinism (TULIP / Monergism)",
        spectrum: 0,
        tags: ["Reformed", "Presbyterian", "Reformed Baptist"],
        summary: "Salvation is entirely God's work. Total Depravity, Unconditional Election, Limited Atonement, Irresistible Grace, Perseverance of the Saints. God sovereignly elects specific individuals for salvation before creation; their salvation is certain.",
        key_texts: ["Eph 1:4–5", "John 6:37–44", "Rom 8:29–30", "John 10:28–29"],
        proponents: "Calvin, Owen, Spurgeon, Packer, Sproul, Piper",
        notes: "Monergism = God alone effects regeneration. 'Once saved always saved' is a popular (often imprecise) version. Perseverance differs from 'easy believism.'"
      },
      {
        name: "Arminianism",
        spectrum: 40,
        tags: ["Wesleyan", "Methodist", "General Baptist"],
        summary: "God elects based on foreknown faith (conditional election). Atonement is universal in scope. Grace enables but does not compel (prevenient grace). Believers can apostatize and lose salvation by persistent rejection of God.",
        key_texts: ["John 3:16", "1 Tim 2:4", "Heb 6:4–6", "2 Pet 2:20–21"],
        proponents: "Arminius, John Wesley, Roger Olson",
        notes: "Not 'salvation by works.' Emphasizes genuine human freedom and responsibility. The Remonstrance (1610) is the founding document."
      },
      {
        name: "Molinism",
        spectrum: 55,
        tags: ["Catholic", "Some Evangelical"],
        summary: "God possesses 'middle knowledge' — knowledge of what free creatures would freely do in any circumstance (counterfactuals of creaturely freedom). God uses this knowledge to providentially arrange history so his purposes are achieved without overriding freedom.",
        key_texts: ["Matt 11:23", "1 Sam 23:10–13"],
        proponents: "Luis de Molina, Alvin Plantinga, William Lane Craig",
        notes: "Attempts to reconcile Calvinist sovereignty and Arminian freedom. Critiqued from both sides — Calvinists say it limits God; Arminians say it smuggles in determinism."
      },
      {
        name: "Open Theism",
        spectrum: 85,
        tags: ["Minority Evangelical"],
        summary: "God does not have exhaustive foreknowledge of future free decisions. The future is 'open' — God knows all possibilities but not which ones free creatures will actualize. God takes real risks in creation and responds genuinely to prayer and human choices.",
        key_texts: ["Gen 22:12", "Jer 3:7", "Jonah 3:10"],
        proponents: "Clark Pinnock, Greg Boyd, John Sanders",
        notes: "Declared a minority evangelical view by the ETS. Critiqued for undermining biblical prophecy. Proponents say it takes biblical 'repentance of God' passages at face value."
      },
    ]
  },
  {
  ...
  },
  {
    id: "gender",
    icon: "⚖️",
    title: "Gender Roles in the Church",
    question: "Can women serve as pastors and elders?",
    views: [
      {
        ...
        <div style={{
          ...
          {categories.map(c => (
            ...
            >
              ...
              <span style={{ letterSpacing: "0.01em" }}>{c.title.split(" ")[0]}</span>
            </button>
          ))}
        </div>
      </div>
